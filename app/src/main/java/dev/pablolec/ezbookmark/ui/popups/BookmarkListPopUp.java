...
public class BookmarkListPopUp {
    ...
    public void showPopupWindow(final View view) {
        showPopupWindow(view, new BookmarkList(""));
    }

    public void showPopupWindow(final View view, BookmarkList bookmarkList) {
